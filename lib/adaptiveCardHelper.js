...
function areSameTextOptions(options1, options2) {
    var options1Keys = Object.keys(options1);
    var options2Keys = Object.keys(options2);
    return options1Keys.length === options2Keys.length &&
        options1Keys.every(optionKey => {
            return options1[optionKey] === options2[options];
        });
}
